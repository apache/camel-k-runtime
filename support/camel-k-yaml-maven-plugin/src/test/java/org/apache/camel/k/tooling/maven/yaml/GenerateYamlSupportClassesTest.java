...
public class GenerateYamlSupportClassesTest {
    ...
    public void testGenerateHasDataFormat() {
        final TypeSpec spec = new GenerateYamlParserSupportClassesMojo().generateHasDataFormat();
    ...
    public void testGenerateHasExpression() {
        final TypeSpec spec = new GenerateYamlParserSupportClassesMojo().generateHasExpression();
        final JavaFile file = JavaFile.builder("org.apache.camel.k.loader.yaml.parser", spec).build();
    ...
    public void testGenerateJacksonModule() {
        final TypeSpec spec = new GenerateYamlLoaderSupportClassesMojo().generateJacksonModule();
