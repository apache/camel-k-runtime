 ...
 */
public final class KnativeHelper {

    private static final Logger LOG = LoggerFactory.getLogger(KnativeHelper.class);

    private KnativeHelper() {
    }

    public static KubernetesClient getKubernetesClient(KnativeConfiguration configuration) {
    ...
    private static KubernetesClient createKubernetesClient(KnativeConfiguration configuration) {
