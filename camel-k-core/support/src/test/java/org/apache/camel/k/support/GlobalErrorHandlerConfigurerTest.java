...
public class GlobalErrorHandlerConfigurerTest {
    ...
    public void globalErrorHandlerIsBoundToSourcesConfigurer() {
        ...
        GlobalErrorHandlerConfigurer configuration = new GlobalErrorHandlerConfigurer();

        PropertiesSupport.bindProperties(
                context,
                configuration,
                k -> k.startsWith(GlobalErrorHandlerConfigurer.CAMEL_K_GLOBAL_ERROR_HANDLER_PREFIX),
