...
public class YamlConfigurerTest {
    ...
    public void yamlDeserializationModeShouldBeEnabledByDefault() {
        ...
        assertThat(context.getGlobalOptions()).containsEntry("CamelYamlDslDeserializationMode", "FLOW");
    }
    ...
    public void yamlDeserializationModeShouldBeEnabledConfigurable() {
        ...
        assertThat(context.getGlobalOptions()).containsEntry("CamelYamlDslDeserializationMode", "CLASSIC");
    }
}
